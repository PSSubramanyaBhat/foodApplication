...
const ChangePassword = () => {
  ...
  const renderTextFieldTitle1 = () => {
    return (
      <View style={styles.fieldTitle}>
        <Text style={styles.descriptionText}>
          {strings.changePasswordText1}
        </Text>
      </View>
    );
  };
  ...
  const renderTextField1 = () => {
    return (
      <View style={styles.inputField}>
        <Image style={styles.icons} source={imagePath.openLockIcon}></Image>
        <TextInput
          style={styles.inputSection}
          placeholder={strings.changePasswordText1}
    ...
    return (
      <View>
        <View style={styles.pageBodySection}>
          {/* TextFields */}
          {renderTextFieldTitle1()}
          {renderTextField1()}
          {renderTextFieldTitle2()}
          {renderTextField2()}
